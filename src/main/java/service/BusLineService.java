...
public class BusLineService implements DataInitializing {
    ...
    public void createNew() {
        System.out.println("Nhập số tuyến xe mới muốn thêm: ");
        int busLineNumber = -1;
        do {
            try {
                busLineNumber = new Scanner(System.in).nextInt();
            } catch (InputMismatchException ex) {
                System.out.print("Số tuyến xe muốn thêm cần nhập là một số nguyên, vui lòng nhập lại: ");
                continue;
            }
            if (busLineNumber > 0) {
                break;
            }
            System.out.print("Số tuyến xe muốn thêm phải là số dương, vui lòng nhập lại: ");
        } while (true);
    ...
    private BusLine inputInfo() {
        ...
        do {
            try {
                ...
                System.out.print("Số điểm dừng phải là một số nguyên, vui lòng nhập lại: ");
                continue;
            }
