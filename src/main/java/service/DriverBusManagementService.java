...
public class DriverBusManagementService implements DataInitializing {
    ...
    public void createNew() {
        ...
        do {
            ...
            System.out.print("Số tài xế phải là một số dương, vui lòng nhập lại: ");
        } while (true);
    ...
    private Map<BusLine, Integer> createBusLine() {
        System.out.print("Nhập số lượng tuyến xe mà tài xế này muốn lái: ");
        int busLineNumber = -1;
        do {
            try {
                busLineNumber = new Scanner(System.in).nextInt();
            } catch (InputMismatchException ex) {
                System.out.print("Số lượng tuyến xe cần nhập là một số nguyên có 5 chữ số, vui lòng nhập lại: ");
                continue;
            }
            if (busLineNumber > 0) {
                break;
            }
            System.out.print("Số lượng tuyến xe phải là số dương, vui lòng nhập lại: ");
        } while (true);
        int totalRound = 0;
        ...
        for (int j = 0; j < busLineNumber; j++) {
            ...
            do {
                ...
                do {
                    try {
                        ...
                        System.out.print("Mã tuyến xe cần nhập là một số nguyên có 3 chữ số, vui lòng nhập lại: ");
                        continue;
                    }
                    if (busLineId > 0) {
                        break;
                    }
                    System.out.print("Mã tuyến xe phải là số dương, vui lòng nhập lại: ");
                } while (true);
            ...
            totalRound += busRound;
            if (totalRound > 15) {
                System.out.println("Tài xế chỉ được lái 15 chuyến một ngày, dừng phân công tại đây.");
                break;
            }
